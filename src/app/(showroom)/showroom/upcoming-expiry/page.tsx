...
export default function ShowroomUpcomingExpiryPage() {
                    ...
                    <TableCell>
                      <div className="flex items-center gap-2">
                        ...
                        {isVerySoon ? (
                          ...
                          <Badge variant="secondary" className="text-[10px] bg-orange-100 text-orange-850 dark:bg-orange-950/40 dark:text-orange-400">
                            {daysRemaining} days left
                          </Badge>
                        )}
                      </div>
